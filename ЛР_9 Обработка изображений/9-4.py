...
input_folder = "D:/Projects_1_MD_8/ЛР_9 Обработка изображений/9-4 без знака2"  # Папка с исходными изображениями
output_folder = "D:/Projects_1_MD_8/ЛР_9 Обработка изображений/9-4 водяной знак2"  # Папка для сохранения результатов
